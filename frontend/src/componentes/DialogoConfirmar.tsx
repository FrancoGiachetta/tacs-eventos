    ...
    return (
        <>
            <div className="fixed top-0 left-0">
                <div className="absolute bg-black opacity-15 w-screen h-screen z-20"></div>

                <div
                    id="cancel-area"
                    className="absolute flex justify-center items-center w-screen h-screen z-30"
                    onClick={(e) => {
                        if (e.target == document.getElementById('cancel-area'))
                            onCancel()
                    }}
                >
                    <div className="bg-white opacity-100 z-10 rounded-md shadow-md min-w-72 min-h-20">
                        ...
                        <div className="p-3">
                            ...
                            <div className="flex flex-row gap-3 justify-end">
                                <button
                                    onClick={onCancel}
                                    className="group p-2 rounded-md hover:text-white hover:bg-red-600 transition duration-300"
                                >
                                ...
                                <button
                                    onClick={onConfirm}
                                    className="group p-2 rounded-md hover:text-white hover:bg-green-600 transition duration-300"
                                >
