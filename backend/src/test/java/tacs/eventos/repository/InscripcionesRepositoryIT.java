...
//
/// / TODO: este fue mi intento de hacer un test del repo pegandole directamente a una instancia de Mongo. Los tests individuales están bien, pero no logré hacer funcionar la configuración para pegarle a Mongo. Si no lo logramos hacer funcionar fácil, borrar la clase entera y dejar el repo sin tests unitarios. De todas formas no tiene queries escritos a mano. Son todos generados autimáticamente por Sptring Boot a partir de los nombres de los métodos.
