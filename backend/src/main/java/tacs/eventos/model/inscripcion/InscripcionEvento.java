...
public class InscripcionEvento {
    ...
    /**
     * Crea una nueva inscripción. NO USAR, usar los métod0s de la clase InscripcionFactory.
     *
     * @param participante
     * @param evento
     ...
     * @return
     */
    protected static InscripcionEvento crearNueva(Usuario participante, Evento evento,
