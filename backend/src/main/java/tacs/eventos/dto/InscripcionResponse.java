...
public record InscripcionResponse(
    ...
    public static InscripcionResponse confirmada(String eventoId, InscripcionEvento inscripcion) {
        return new InscripcionResponse(eventoId, EstadoInscripcionResponse.CONFIRMADA, inscripcion.getParticipante().getEmail(), inscripcion.getFechahoraConfirmacion(), inscripcion.getId());
    }
    ...
    public static InscripcionResponse enWaitlist(String eventoId, InscripcionEvento inscripcion) {
        return new InscripcionResponse(eventoId, EstadoInscripcionResponse.PENDIENTE, inscripcion.getParticipante().getEmail(), inscripcion.getFechahoraConfirmacion(), inscripcion.getId());
    }
}
